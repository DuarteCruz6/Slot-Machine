Public Class Form2
    ...
    Private Sub bttOk_Click(sender As Object, e As EventArgs) Handles bttOk.Click
        ...
        ElseIf i = 1 Then
            ...
            lblN3.Visible = True
            i += 1
            lblRegras.Text = "Após clicar no botão, os 3 espaços irão mudar de números aleatoriamente, até que vão todos parando, sucessivamente. O botão ´Jogar´ estará desativado enquanto isto acontece."
